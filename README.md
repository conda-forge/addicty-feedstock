...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/addicty-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13499&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/addicty-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `addicty` can be installed with:

```
conda install addicty
```

It is possible to list all of the versions of `addicty` available on your platform with:
